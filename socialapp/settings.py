...
SECRET_KEY = 'xf0gxp$q4_jv&l!s%=(rkafjbv!y#)*v5@=+ky^8e77v(w!-g^'
...
# [redirecting the user when authentication is complete]
...
SOCIAL_AUTH_FACEBOOK_KEY = '2571990409783721'       # App ID
SOCIAL_AUTH_FACEBOOK_SECRET = '092786bcb7c690d5a40f8f47e11f94f5'  # App Secret
